# -*- coding: utf-8 -*-
#
# teaching documentation build configuration file, created by
...
#html_theme_options = {}
html_theme_options = {
    'description': 'LES data analysis',
    'github_button': False,
    'extra_nav_links': {"Home page": 'http://matthew.dynevor.org'},
}
...
html_title = u"Tutorials on imaging, computing and mathematics"
...
latex_documents = [
  (master_doc, 'les_data_analysis.tex', html_title,
...
man_pages = [
    (master_doc, 'les_data_analysis', html_title,
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'les_data_analysis', html_title,
   author, 'les_data_analysis', 'One line description of project.',
   'Miscellaneous'),
]
...
markdown_http_base = 'https://matthew-brett.github.io/les-pilot'
